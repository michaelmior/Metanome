...
public abstract class ConfigurationSettingJsonInput extends ConfigurationSettingDataSource {
   ...
   */
  @XmlTransient
  public abstract void generate(JsonInputGeneratorInitializer initializer)
