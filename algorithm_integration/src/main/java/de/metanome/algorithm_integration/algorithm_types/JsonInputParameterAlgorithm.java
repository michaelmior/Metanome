...
/**
 * An {@link Algorithm} that takes {@link JsonInputGenerator} configuration values.
 *
 * @author Michael Mior
 */
public interface JsonInputParameterAlgorithm extends Algorithm {

  /**
   * Sets a JsonInputGenerator configuration value on the algorithm.
   *
   ...
   *                                                                           values
   */
  void setJsonInputConfigurationValue(String identifier, JsonInputGenerator... values)
