...
/**
 * Generates new copies of a {@link JsonInput}.
 *
 * @author Michael Mior
 */
public interface JsonInputGenerator extends AutoCloseable {
   ...
   */
  public JsonInput generateNewCopy() throws InputGenerationException, AlgorithmConfigurationException;
}
