 ...
 * @author Michael Mior
 */
public class DefaultJsonInputGenerator implements FileInputGenerator {

  File inputFile;
  protected ConfigurationSettingFileInput setting;

  protected DefaultJsonInputGenerator() {
  }

  /**
   * Creates a DefaultJsonInputGenerator with default settings. The default setting is used to
   ...
   */
  public DefaultJsonInputGenerator(File inputFile) throws FileNotFoundException {
   ...
   */
  public DefaultJsonInputGenerator(ConfigurationSettingFileInput setting)
  ...
  public DefaultJsonInputGenerator(File inputFile, ConfigurationSettingFileInput setting)
  ...
  public RelationalInput generateNewCopy() throws InputGenerationException {
    try {
      return new JsonIterator(inputFile.getName(), new RandomAccessFile(inputFile, "r"), setting);
    } catch (FileNotFoundException e) {
